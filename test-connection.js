// quick test to see if frontend can connect to backend
...
async function testConnection() {
  ...
  try {
    ...
    if (requestsRes.status === 401) {
      ...
      console.log('   Response:', await requestsRes.text());
    }
    ...
    console.log('4. See backend/docs/API.md for endpoint details');
